...
GROUP BY order_hour
ORDER BY order_hour;
🍽️ 9. Find the category-wise distribution of pizzas
sql
Copy
Edit
...
✅ **This is your final GitHub-ready README file.**  
🔥 **Just copy-paste it into your `README.md` file on GitHub.** 🚀
